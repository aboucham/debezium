...
[source, yaml,indent=0]
----
curl debezium-connect-connect-0.debezium-connect-connect.dbz-mysql.svc:8083/connectors
["mysql-connector"] 
----
[source, yaml,indent=0]
----
curl debezium-connect-connect-0.debezium-connect-connect.dbz-mysql.svc:8083/connectors/mysql-connector/status
