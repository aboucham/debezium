...
status:
  conditions:
    - lastTransitionTime: '2023-10-24T10:17:25.282337453Z'
      status: 'True'
      type: Ready
  connectorPlugins:
    ...
    - class: org.apache.kafka.connect.mirror.MirrorSourceConnector
      ...
      version: 3.5.0.redhat-00014
  labelSelector: >-
    strimzi.io/cluster=dbz-mysql-connect,strimzi.io/name=dbz-mysql-connect-connect,strimzi.io/kind=KafkaConnect
  observedGeneration: 1
  replicas: 1
  url: 'http://dbz-mysql-connect-connect-api.dbz-mysql.svc:8083'
----
